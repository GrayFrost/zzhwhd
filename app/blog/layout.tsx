...
export default function Layout({
  ...
  return (
    <div className="w-full">
      <div className="h-24 bg-rose-200">banner</div>
      <div className="max-w-5xl flex flex-wrap items-center justify-between mx-auto p-2 sm:p-0 sticky top-0 bg-rose-200">
        <h1 className="space-x-2">博客</h1>
